...
class Covid extends Component {
  ...
  async getContent(p) {
    try {
      ...
      this.setState({
        name: district,
        active: active.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"),
          ...
          <div className="card">
            <div className="Tilt-inner main-card">
              ...
              <p className="card-text">
                Confirmed cases: <span id="red">{confirmedCases}</span>
              </p>
              <p className="card-text">
                Active cases: <span>{active}</span>
              </p>
              <p className="card-text">
                Recovered: <span id="green">{recovered}</span>
              </p>
              <p className="card-text">
                Decreased: <span id="grey">{decreased}</span>
              </p>
            </div>
          </div>
        </div>
